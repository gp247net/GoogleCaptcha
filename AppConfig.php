 ...
 * Plugin format 1.0
 */
#App\GP247\Plugins\GoogleCaptcha\AppConfig.php
namespace App\GP247\Plugins\GoogleCaptcha;

use App\GP247\Plugins\GoogleCaptcha\Models\ExtensionModel;
...
class AppConfig extends ExtensionConfigDefault
{
    ...
    //Message error captcha call in GP247\Core\Rules\CaptchaRule
    public static function msgError() {
        return 'Error captcha';
    }

    //Validate captcha call in GP247\Core\Rules\CaptchaRule
    public function validate( string $value)
    {
        ...
        $response = $client->post(
            ...
            ['form_params'=>
                [
                    'secret'   => gp247_config($this->configKey.'_secrect_key'),
                    'response' => $value
                 ]
            ]
        );
